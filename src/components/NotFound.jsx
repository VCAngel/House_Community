...
export default function NotFound() {
    return (
        <Box h="100vh" display="flex" justifyContent="center" alignItems="center">
            <Box boxSize="2xl" h="fit-content" boxShadow="base" p="6" rounded="md" display="grid" gridAutoFlow="column" gap={5}>
                ...
                <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="4">
                    <Box align="center">
                        <Heading as='h1' size="3xl">¡Oh no!</Heading>
                        <Heading as="h2" size="xl">La página no existe...</Heading>
                    </Box>
